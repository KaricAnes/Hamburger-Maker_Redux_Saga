...
import { put, call } from "redux-saga/effects"; //da bismo mogli returnati type u funkciji logout() koji ce ici do reducera
...
export function* logoutSaga(action) {
  ...
  //yield call([localStorage, "removeItem"], "token");  //we make our generators testable
