...
function* logout(action) {
  localStorage.removeItem("userId"); //U action generatorima svaki step nam treba biti prefixed sa yield keyword
  localStorage.removeItem("token"); // yielld je garancija da kod nece nastaviti dalje dok se prethodni ne zavrsi
