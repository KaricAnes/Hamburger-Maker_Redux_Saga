...
import { logoutSaga, checkAuthTimoutSaga, authSaga } from "./authSagas";
import * as actionTypes from "../actions/actionTypes";

export function* watchAuth() {
  debugger; //2
  yield takeEvery(actionTypes.AUTH_INITIATE, authSaga);
  yield takeEvery(actionTypes.CHECK_TIMEOUT_INITIATE, checkAuthTimoutSaga);
  yield takeEvery(actionTypes.AUTH_INITIATE_LOGOUT, logoutSaga);
  yield takeEvery(actionTypes.AUTH_CHECK_STATE_INITIATE, logoutSaga);
