...
export function* authSaga(action) {
  ...
  yield axios
    ...
    .then((response) => {
      ...
      yield put(actions.authSuccess(response.data.idToken, response.data.localId)); //authR.js const authSuccess
    ...
    .catch((err) => {
      ...
      /*
       ...
       yield put(actionsauthFailed(err.response.data.error)); //Auth.js  {this.props.error.message}
      //debugger;
    });
}
